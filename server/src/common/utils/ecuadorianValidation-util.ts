...
export const validateEcuadorianRUC = (rucInput: string | number): boolean => {
  const ruc = typeof rucInput === 'number' ? rucInput.toString() : rucInput
...
export const validateCedula = (cedulaInput: string | number): boolean => {
  const cedula =
    typeof cedulaInput === 'number' ? cedulaInput.toString() : cedulaInput
...
export const validatePersonaJuridica = (rucInput: string | number): boolean => {
  const ruc = typeof rucInput === 'number' ? rucInput.toString() : rucInput
...
export const validateEntidadPublica = (rucInput: string | number): boolean => {
  const ruc = typeof rucInput === 'number' ? rucInput.toString() : rucInput
