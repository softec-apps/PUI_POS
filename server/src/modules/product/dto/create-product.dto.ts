...
export class CreateProductDto {
  /*
   *NOTE: El campo "code" genera internamente en base al id (uuid-> la primera secuencia (upperCase)) + secuencia de productos en el sistema (00001).
   *Ej: PROD-AF165F29-00001
   **/
