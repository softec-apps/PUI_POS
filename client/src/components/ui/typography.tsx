...
const typographyVariants = cva('', {
	variants: {
		variant: {
			...
			p: 'leading-relaxed text-base sm:text-lg text-muted-foreground max-w-prose',
			...
			blockquote: 'border-l-4 border-primary/30 pl-6 italic text-muted-foreground bg-muted/30 py-4 rounded-r-lg',
