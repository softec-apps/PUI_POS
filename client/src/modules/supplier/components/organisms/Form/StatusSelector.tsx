...
import { STATUS_OPTIONS } from '@/modules/supplier/constants/supplier.constants'
	...
	return (
		<Card className='border-none bg-transparent p-0 shadow-none'>
			<CardHeader className='p-0'>
				...
				<CardDescription>Selecciona si el proveedor debe estar activo o inactivo dentro del sistema.</CardDescription>
			</CardHeader>
