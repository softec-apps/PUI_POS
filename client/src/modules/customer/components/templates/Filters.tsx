...
import { SortDropdown } from '@/modules/customer/components/organisms/Filters/SortDropdown'
import { IdentificationTypeDropdown } from '@/modules/customer/components/organisms/Filters/IdentificationTypeDropdown'
import { DateFiltersDropdown } from '@/modules/customer/components/organisms/Filters/DateFiltersDropdown'
import { DateFilters, DateFilterType, DateRange } from '@/common/types/pagination'
import { IdentificationType } from '@/common/enums/customer.enum'
...
export function Filters({
	...
	const clearIdentificationType = () => onIdentificationTypeChange(null)
				...
				<motion.div
					...
					<div className='relative flex items-center gap-2'>
						<IdentificationTypeDropdown
							...
							onIdentificationTypeChange={onIdentificationTypeChange}
						/>
						{currentIdentificationType !== null && (
							<ActionButton
								icon={<Icons.x />}
								onClick={clearIdentificationType}
								variant='ghost'
								size='sm'
								className='h-8 w-8'
							/>
