...
export function MediaSection({ control, setValue, watch, recordData, currentRecord }: MediaSectionProps) {
	...
	// Obtener la imagen completa del recordData si está disponible
	const getImageForDisplay = () => {
		// Si tenemos recordData y tiene photo como objeto, usarlo
		if (recordData?.photo && typeof recordData.photo === 'object') return recordData.photo
	...
	return (
		<Card className='border-none bg-transparent p-0 shadow-none'>
			<CardHeader className='p-0'>
				...
				<CardDescription>Sube una imagen representativa del usuario</CardDescription>
			</CardHeader>
