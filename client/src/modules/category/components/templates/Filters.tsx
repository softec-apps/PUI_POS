...
import { SortDropdown } from '@/modules/category/components/organisms/Filters/SortDropdown'
import { StatusDropdown } from '@/modules/category/components/organisms/Filters/StatusDropdown'
import { DateFiltersDropdown } from '@/modules/category/components/organisms/Filters/DateFiltersDropdown'
...
export function Filters({
	...
	const clearAllDateFilters = () => {
		Object.keys(dateFilters).forEach(key => onClearDateFilter(key as DateFilterType))
	}
		...
		<div className='space-y-4'>
			...
			<div className='flex flex-col justify-between gap-4 md:flex-row md:items-center'>
				...
				<motion.div
					...
					{/* 
					{hasActiveFilters && (
						<ActionButton icon={<Icons.x />} text='Limpiar Todo' onClick={onResetAll} variant='destructive' size='sm' />
					)}
					*/}
