...
import { CardView } from '@/modules/user/components/templates/ViewCard'
import { ListView } from '@/modules/user/components/templates/ViewList'
...
interface TableUserProps {
	...
	onRestore: (recordsData: I_User) => void
...
export function TableUser({
	...
	const handleEdit = useCallback((user: I_User) => onEdit(user), [onEdit])
	const handleSoftDelete = useCallback((user: I_User) => onSoftDelete(user), [onSoftDelete])
	const handleHardDelete = useCallback((user: I_User) => onHardDelete(user), [onHardDelete])
	const handleRestore = useCallback((user: I_User) => onRestore(user), [onRestore])
